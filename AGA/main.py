...
from model.models import STCLAGA
...
def model_supervisor(args):
    ...
    model = STCLAGA(args).to(args.device)
...
if __name__=='__main__':
    ...
    parser.add_argument('--config_filename', default='/Users/zdk/Desktop/tj2024spring/0024s时空增强自监督学习/AGA02/configs/PEMS04.yaml', 
